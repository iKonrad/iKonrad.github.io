	  ...
	  Console.prototype.print = function () {
	    var _ref = _asyncToGenerator(function* (command) {
	      ...
	      if (command === 'clear') {
	        ...
	        var response = (0, _consoleEngine2.default)(command.toLowerCase());
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (typeof window !== 'undefined') {
	  ...
	  window['openSource'] = function () {
	    var win = window.open('https://github.com/iKonrad/homepage-sourcecode', '_blank');
	    win.focus();
	  };
...
//# sourceMappingURL=component---src-pages-index-js-86674e76c4e76ddd2013.js.map